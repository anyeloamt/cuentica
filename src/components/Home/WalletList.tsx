...
function WalletListComponent({
  ...
  if (walletsWithId.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center text-text-secondary bg-bg-secondary rounded-2xl border-2 border-dashed border-border">
